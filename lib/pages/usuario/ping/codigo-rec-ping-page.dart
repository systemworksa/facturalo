...
class ValidarCodigoPingPage extends StatefulWidget {
  const ValidarCodigoPingPage({Key? key}) : super(key: key);

  @override
  State<ValidarCodigoPingPage> createState() => _ValidarCodigoPingPageState();
}

class _ValidarCodigoPingPageState extends State<ValidarCodigoPingPage> {
 ...
 // final Connectivity _connectivity = Connectivity();
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Ingrese el código de verificación que le llegó a su correo electrónico .',
                      ...
                      MyCustomInputBox(
                        label: 'Código',
                        inputHint: 'Ingrese código de verificación...',
  ...
  validarCodigo() async {
    if (codigoController.text.toString() == "") {
      message.showToast('El código es un campo obligatorio');
      return;
    }
    ...
    Future<dynamic> resp = usuarios.validarCodigo(
        codigoController.text, prefs.getString('emailRecuperacion'));
      ...
      for (var child in json2) {
        if (child["status"]) {
          setState(() {
            ...
            Navigator.pushNamed(context, 'actualizar-ping');
