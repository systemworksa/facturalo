...
class EmailVerificacionPage extends StatefulWidget {
  const EmailVerificacionPage({Key? key}) : super(key: key);

  @override
  State<EmailVerificacionPage> createState() => _EmailVerificacionPageState();
}

class _EmailVerificacionPageState extends State<EmailVerificacionPage> {
      ...
      for (var child in json2) {
        if (child["status"]) {
          setState(() {
            ...
            Navigator.pushNamed(context, 'validar-codigo');
          });
        } else {
