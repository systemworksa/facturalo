...
class ActualizarclavePage extends StatefulWidget {
  const ActualizarclavePage({Key? key}) : super(key: key);

  @override
  State<ActualizarclavePage> createState() => _ActualizarclavePageState();
}

class _ActualizarclavePageState extends State<ActualizarclavePage> {
  final message = ToastMessage();
  final claveController = TextEditingController();
  final repetirClaveController = TextEditingController();
 ...
 // final Connectivity _connectivity = Connectivity();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyCustomInputBox(
                        ...
                        inputHint: 'Ingrese nueva clave...',
                        inputController: claveController,
                        formatter: false,
                      ),
                      MyCustomInputBox(
                        label: 'Repita su nueva clave',
                        inputHint: 'Ingrese nueva clave...',
                        inputController: repetirClaveController,
                        formatter: false,
                      ),
  ...
  validarCodigo() async {
    if (repetirClaveController.text.toString() == "" ||
        claveController.text.toString() == "") {
      message.showToast('Todos los campos de ingreso son obligatorios');
      return;
    }
    ...
    if (repetirClaveController.text.toString() !=
        claveController.text.toString()) {
      message.showToast(
          'Las claves no coinciden por favor verifique e intente nuevamente');
      return;
    }
    ...
    Future<dynamic> resp = usuarios.actualizarClave(
        claveController.text, prefs.getString('emailRecuperacion'));
